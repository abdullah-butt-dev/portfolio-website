...
export const metadata = {
  title: "Engineering Blog | Abdullah",
  description:
    "Writings on distributed systems, workload identity, microservices architecture, and high-performance web engineering.",
};
        ...
        <Container>
          <div className="max-w-3xl space-y-6">
            ...
            <p className="text-lg text-slate-400 leading-relaxed font-normal">
              Practical architectural patterns, systems analysis, and post-mortems from building scalable software. No marketing fluff—strictly technical explorations.
            </p>
          </div>
        </Container>
      </section>
